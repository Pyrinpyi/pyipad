...
import (
	...
	"github.com/Pyrinpyi/pyipad/domain/consensus/utils/virtual"
...
// This is a sanity test, to make sure that pyipad doesn't store, and subsequently sends syncing peers the wrong UTXOSet.
