...
// installService attempts to install the pyipad service. Typically this should
...
// removeService attempts to uninstall the pyipad service. Typically this should
...
// startService attempts to Start the pyipad service.
