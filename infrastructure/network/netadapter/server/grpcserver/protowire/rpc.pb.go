...
type GetBlockTemplateResponseMessage struct {
	...
	// Whether pyipad thinks that it's synced.
	// Callers are discouraged (but not forbidden) from solving blocks when pyipad is not synced.
	// That is because when pyipad isn't in sync with the rest of the network there's a high
...
type GetConnectedPeerInfoMessage struct {
	...
	// Whether this pyipad initiated the connection
	...
	// The timestamp of when this peer connected to this pyipad
