...
In order maintain the peer-to-peer Pyrin network, there needs to be a source
of addresses to connect to as nodes come and go. The Pyrin protocol provides
