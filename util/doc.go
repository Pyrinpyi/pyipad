...
A Block defines a pyrin block that provides easier and more efficient
...
A Tx defines a pyrin transaction that provides more efficient manipulation of
...
The Address interface provides an abstraction for a pyrin address. While the
most common type is a pay-to-pubkey, pyrin already supports others and
...
To decode/encode an address:
	...
	addrString := "pyrin:qqj9fg59mptxkr9j0y53j5mwurcmda5mtza9n6v9pm9uj8h0wgk6uma5pvumr"
