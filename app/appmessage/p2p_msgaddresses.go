...
// pyrin Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a pyrin
// Addresses message.
...
// NewMsgAddresses returns a new pyrin Addresses message that conforms to the
