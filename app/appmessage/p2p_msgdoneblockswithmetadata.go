...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a pyrin
...
// NewMsgDoneBlocksWithTrustedData returns a new pyrin DoneBlocksWithTrustedData message that conforms to the
// Message interface.
